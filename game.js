...
function setLangAndUpdateUI(id) {
	...
	if (id == "日本語") {
		...
		mui.YourPoint = "貴方の点数：";
		mui.ComPoint = "ＣＯＭの点数：";
		mui.YouBusted = "貴方は21点を超えた。";
		mui.ComBusted = "ＣＯＭは21点を超えた。";
		mui.BothBusted = "両方も21点を超えた。";
		mui.YouExact21 = "貴方はちょうど21点です。";
		mui.ComExact21 = "ＣＯＭはちょうど21点です。";
		mui.BothExact21 = "両方はちょうど21点です。";
		mui.You5Card = "貴方は、五枚カードを取ったが、まだ21点未満です。";
		mui.Com5Card = "ＣＯＭは、五枚カードを取ったが、まだ21点未満です。";
		mui.Both5Card = "両方は、五つカードを取ったが、まだ21点未満です。";
		mui.YouScoreBetter = "貴方の点数より高い。";
		mui.ComScoreBetter = "ＣＯＭの点数より高い。";
		mui.SameScore = "両方の点数は同じです。";
		mui.WhatHappened = "え、何が起きたか";
		mui.YouWin = "勝った！";
		mui.YouLose = "負けった！";
		mui.DrawGame = "引き分け。";
	}
		...
		mui.WhatHappened = "What happened?";
		mui.YouWin = "You win!";
